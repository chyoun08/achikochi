		...
		$.ajax({
			...
			error : function(jqXHR, textStatus, errorThrown) {
				if (jqXHR.responseText == "timeout") {
					...
					alertify.notify('エラー', 'error', //'error','warning','message'
					3, //-1
					function() {
	...
	<div>
		<div class="table-responsive">
			<table class="table">
				...
				<tr>
						<th>カテゴリ</th>
						<td colspan="5"><select class="span6 m-wrap" name="category"
							id="category">
								<option value="1">ファッション衣類 ・ 雑貨</option>
								<option value="2">化粧品</option>
								<option value="3">キッチン用品</option>
								<option value="4">生活用品</option>
								<option value="5">ホームインテリア</option>
								<option value="6">家電 ・ デジタル</option>
								<option value="7">スポーツ ・ レジャー</option>
								<option value="8">自動車用品</option>
								<option value="9">図書 ・ レコード ・ DVD</option>
								<option value="10">玩具 ・ 趣味</option>
								<option value="11">文具 ・ オフィス</option>
								<option value="12">ペット用品</option>
				...
				<tr>
					<th>値段</th>
					<td>
						<input type="text" name="price" id="price" min="1000"> 円
					</td>
				</tr>
				<tr>
					<th>詳細説明</th>
					<td colspan="5"><textarea id="board"
							style="width: 98%; height: 200px;" name=""></textarea></td>
				</tr>
				<tr>
					<th>商品イメージ</th>
		...
		<div class="text-center">
			<input type="button" id="upload" value="登録" class="btn btn-success">
